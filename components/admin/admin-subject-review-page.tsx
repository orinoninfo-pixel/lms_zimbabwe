    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button variant="outline" onClick={() => void save("rejected")} disabled={!subject} loading={isSaving}>
            Reject
          </Button>
          <Button variant="outline" onClick={() => void save("suspended")} disabled={!subject} loading={isSaving}>
            Suspend
          </Button>
          <Button variant="secondary" onClick={() => void save()} disabled={!subject} loading={isSaving}>
            {isSaving ? "Saving..." : "Save Changes"}
          </Button>
          <Button onClick={() => void save("approved")} disabled={!subject || !approvalReady} loading={isSaving}>
            Save and Approve
          </Button>
        </div>
      </div>
